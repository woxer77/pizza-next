      ...
      <header className={cn('w-full flex items-center py-11 container', className)}>
        ...
        <div className="flex shrink-0 gap-4">
          ...
          <Button className="relative group">
            ...
            <MoveRight className="absolute top-1/2 right-6 h-8 w-8 -translate-y-1/2 opacity-0 transition duration-300 group-hover:opacity-100 group-hover:translate-x-2" />
          </Button>
        </div>
      </header>
    </div>
